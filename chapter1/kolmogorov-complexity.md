...
尽管两者都有难度，但是毫无疑问的是后者更难。这实际上是由于后者包含的随机性更大，更难以被记忆。也就是说：一段话包含的信息越多，我们就越难以记住它。实际上是因为我们的大脑是一个出色的压缩器，它总是通过压缩的方法来记忆信息，越是随机，信息量就越大，也就越难以记住。

但是这里仍然有一件反直觉的事情，那就是会有人认为更多的模式意味着更多的信息。那么此时，这些人实际上是以随机性的倒数来理解信息。

从数学的角度来看，这种看法与直接使用随机性度量信息并无区别，所以我们还是采用最原本的随机性的角度来理解信息。个人认为这种理解其实是由于我们的大脑天生的容易发现模式，并受到模式的刺激。
